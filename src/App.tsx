...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans selection:bg-cyan-500 selection:text-zinc-950 pb-16 md:pb-6 relative overflow-x-hidden">
      {/* Background ambient lighting effects */}
      <div className="fixed inset-0 pointer-events-none bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(14,165,233,0.12),rgba(255,255,255,0))] z-0" />
      ...
      <div className="flex-1 relative z-10">
        <Dashboard
          ...
          isShiftReportOpen={isShiftReportOpen}
          setIsShiftReportOpen={setIsShiftReportOpen}
      ...
      <footer className="relative z-10 border-t border-zinc-800/80 bg-zinc-950/90 backdrop-blur-md py-3.5 px-4 text-center text-xs text-zinc-500 hidden md:block">
        <div className="max-w-7xl mx-auto flex items-center justify-between font-mono text-[11px]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-400 font-semibold tracking-wide">SYSTEM: GAMEHUB INTERNET CAFE ENGINE ONLINE</span>
          </div>
          <p className="text-zinc-500 tracking-wider">
            TOUCH OPTIMIZED • REAL-TIME LOCAL SYNC • 3 PS4 + 1 PANDORA BOX + 4 BILLIARDS
          </p>
        </div>
      </footer>
    </div>
